...
extension AppCoordinator {
    ...
    private func startInitialServices() {
        ...
        serviceHolder.add(BooksService.self, for: booksService)
        
        let booksDetailService = BooksDetailService()
        serviceHolder.add(BooksDetailService.self, for: booksDetailService)
    }
}
